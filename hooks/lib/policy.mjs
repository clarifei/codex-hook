...
function policyFor(style) {
  if (!['beeline', 'caveman'].includes(style)) throw new Error('install exactly one beeline or caveman skill');
  const skill = (name) => path.join(codexHome, 'skills', name, 'SKILL.md');
