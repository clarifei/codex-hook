    ...
    skills: [
      {
        ...
        sources: [source('mattpocock/skills', 'skills/engineering', 'matt-pocock/matt-pocock-engineering')],
      },
      {
        id: 'matt-pocock-productivity',
        label: 'Productivity',
        description: 'Productivity workflows',
        sources: [source('mattpocock/skills', 'skills/productivity', 'matt-pocock/matt-pocock-productivity')],
      },
    ],
  },
  {
    ...
    skills: [
      {
        ...
        sources: [source('denoland/skills', 'skills/deno', 'deno/deno')],
      },
      {
        id: 'deno-deploy',
        label: 'Deno Deploy',
        description: 'Deno Deploy',
        sources: [source('denoland/skills', 'skills/deno-deploy', 'deno/deno-deploy')],
      },
    ],
  },
  {
    ...
    skills: [
      {
        ...
        sources: [
          source('tanstack-skills/tanstack-skills', 'plugins/tanstack-ai/skills/tanstack-ai', 'tanstack/tanstack-ai'),
        ],
      },
      {
        id: 'tanstack-query',
        ...
        sources: [
          source(
            ...
            'plugins/tanstack-query/skills/tanstack-query',
