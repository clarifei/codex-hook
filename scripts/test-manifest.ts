    ...
    skills: [
      {
        ...
        sources: [source('mattpocock/skills', 'skills/engineering', 'matt-pocock/engineering')],
      },
      {
        id: 'matt-pocock-productivity',
        label: 'Productivity',
        description: 'Productivity workflows',
        sources: [source('mattpocock/skills', 'skills/productivity', 'matt-pocock/productivity')],
      },
    ],
  },
  {
    ...
    skills: [
      {
        ...
        sources: [
          source('tanstack-skills/tanstack-skills', 'plugins/tanstack-ai/skills/tanstack-ai', 'tanstack/ai'),
        ],
      },
      {
        id: 'tanstack-query',
